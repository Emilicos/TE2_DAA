# Inspired by Andrea Rubbi from https://github.com/AndreaRubbi/Set-Cover-problem-solution-Python/blob/master/Greedy.py
...
def set_cover(universe, subsets,costs):
    cost=0
    elements = set(e for s in subsets for e in s) # Set dari semua elemen
...
def main(a,b,c,x=time.time()):
    m= a
    universe = set(range(1, m+1)) # set berupa semua elemen yang harusnya ada dalam 
    sub = b  
    
    subsets = [set(x) for x in sub] # list berupa set dari setiap elemen pada S
    costs =  c 
